...
from kalshi_cricket_tracker.execution.btc15m_lifecycle import finalize_market_run, run_supervisor, wait_for_market_snapshot
...
def test_run_supervisor_can_anchor_on_next_market(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda cfg, ticker, max_runtime_seconds, poll_seconds: {'ticker': ticker},
    )
